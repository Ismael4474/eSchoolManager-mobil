...
public class FragModiBeca extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_frag_modi_beca, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editTextCodiModi = view.findViewById(R.id.editTextModiBeca);
        buttonModiBuscar = view.findViewById(R.id.buttonBaixaTrobarBeca);

        buttonModiBuscar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String resposataServidor = cercarBeca(view);
                if (resposataServidor != null){
                    ...
                    fragmentManager.beginTransaction().add(R.id.frameLayoutModiBeca, new FragModiBecaResult()).commit();
    ...
    public String cercarBeca(View view){
        ...
        try {
            ...
            jsonDades.put("codiBeca",editTextCodiModi.getText().toString());
