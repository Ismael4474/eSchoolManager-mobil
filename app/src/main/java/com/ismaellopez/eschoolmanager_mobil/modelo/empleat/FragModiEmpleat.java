...
public class FragModiEmpleat extends Fragment {

    View view;
    EditText editTextCodiModi;
    Button buttonModiBuscar;

    public FragModiEmpleat() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_frag_modi_empleat, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        editTextCodiModi = view.findViewById(R.id.editTextModiEmpleat);
        buttonModiBuscar = view.findViewById(R.id.buttonBaixaTrobarEmpleat);

        buttonModiBuscar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String resposataServidor = cercarEmpleat(view);
                if (resposataServidor != null){
                    ...
                    fragmentManager.beginTransaction().add(R.id.frameLayoutModiEmpleat, new FragModiEmpleatResult()).commit();
                }
            }
        });
    }

    public String cercarEmpleat(View view){
        ...
        try {
            ...
            jsonDades.put("codiEmpleat",editTextCodiModi.getText().toString());
